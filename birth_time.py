"""
birth_time.py    생일별 학교 입학 년도   Ver 1.0_240519
"""
...
for i in range(70):
    ...
    print(birth_range, "초등학교 ", str(ele_year), "년 대학교", univ_num,"학번")

# 예외 값 처리 --- (4)
sheet["A2"]="2024년 3월 1일생 ~ 2025년 12월 31일생"

# 파일 저장
book.save("output/연령별학교입학.xlsx")
